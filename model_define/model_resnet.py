...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, embedding_size=512):
        ...
        ks = 7
        self.fc1 = nn.Conv2d(512*block.expansion, embedding_size, kernel_size=ks, bias=False)
        self.ft1 = Flatten()
...
if __name__ == '__main__':
    ...
    state_dict = torch.load('/home/user1/linx/program/LightFaceNet/work_space/models/model_train_best/2019-10-06-07'
                            '-23_LiveBody_re_rm_n_0.15_80x80_fake-20190924-train-data_live-0926_ResNet34v3-d128'
                            '-c4_pytorch_iter_42000.pth')
